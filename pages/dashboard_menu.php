...
<html lang="en">
    ...
    <head>
        ...
        try {
            ...
            // js_console_log("This is a log from the dashboard_menu.php");
    ...
    <body>
        <div class="container" id="foretext_container">
            <div class="page-header">
                <h1>Dashboard <small>Informazioni relative al servizio di allerta meteo di Protezione Civile</small>
                </h1>
            </div>
                    ...
                    <div class="container" id="API_bttn_msg_container">
                        <form>
                            <div class="form-group">
                                ...
                                <span class="help-block">OPZIONALE: valore utile per la modifica di messaggi caricati in
                                    precedenza.</span>
                            </div>
                            <div class="form-group">
