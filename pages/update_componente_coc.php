...
$subtitle="Dettagli Componente COC"
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header"> <i class="fa fa-user"></i> Dettagli Componente COC Direttivo
                    
                    <?php
                    $check_profilo=0;
                    $query="SELECT * From users.utenti_coc where matricola_cf=$1;"; 
            ...
            <b>Codice fiscale</b>: <?php echo $r['matricola_cf'] ?>  <br>
            <br>
			
			<?php
			if ($profilo_sistema<=3){
			?>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_ana_coc"> 
...
<!-- Modal -->
<div id="modal_ana_coc" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Edit anagrafica Componente COC</h4>
      </div>
