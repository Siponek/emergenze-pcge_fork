...
$query="INSERT INTO report.t_operatore_volontari (matricola_cf,data_start,data_end, warning_turno) VALUES";
...
$query_log= "INSERT INTO varie.t_log (schema,operatore, operazione) VALUES ('report','".$operatore ."', 'Inserimento operatore volontari: ".$cf."');";
