...
$query="INSERT INTO report.t_tecnico_pc (matricola_cf,data_start,data_end, warning_turno) VALUES";
...
$query_log= "INSERT INTO varie.t_log (schema,operatore, operazione) VALUES ('report','".$operatore ."', 'Inserimento tecnico P.C.: ".$cf."');";
