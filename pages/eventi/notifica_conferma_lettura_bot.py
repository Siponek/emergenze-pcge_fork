...
testo='{} {} Non è ancora stata inviata la conferma di avvenuta lettura. Si prega di dare riscontro alla comunicazione precedentemente inviata premendo il tasto OK.'.format(emoji.emojize(":warning:",use_aliases=True),emoji.emojize(":bell:",use_aliases=True))
