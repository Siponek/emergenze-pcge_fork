...
async def inline_kb_answer_callback_handler(query: types.CallbackQuery):
    ...
    if answer_data == 'ricevuto':
        ...
        if result_c == 1:
            ...
            text='Gentile {}, hai dato conferma di lettura dell\'emanazione dell\'allerta emanata in data {}. Ti ricordiamo di controllare nei prossimi minuti la tua casella di posta elettronica per avere informazioni su data, ora e luogo di convocazione del COC Direttivo'.format(result_s[0][1], result_s[0][5])
