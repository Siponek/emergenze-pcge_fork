<!DOCTYPE html>
<html lang="en">
    <?php $subtitle = "Dashboard o pagina iniziale"; ?>
    ...
    <head>
        ...
        <?php
        require "./req.php";
        require explode("emergenze-pcge", getcwd())[0] .
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                                                ...
                                                <section id="segn_limbo_table">
                                                    <table id="segnalazioni_limbo" class="table table-condensed"
                                                        ...
                                                        function nameFormatterEditL(value) {
                                                            ...
                                                            return '<a class="btn btn-warning" title="Visualizza dettagli" href=./dettagli_segnalazione.php?id=' +
                                                                value + '>' + value +
                                                ...
                                                <section id="segn_limbo2_table">
                                                    ...
                                                    <table id="segnalazioni" class="table table-condensed"
                                                        ...
                                                        function nameFormatterEdit(value) {
                                                            ...
                                                            return '<a class="btn btn-warning btn-sm" title="Vai ai dettagli" href=./dettagli_segnalazione.php?id=' +
                                                                value + '>' + value +
                                                                '<!--i class="fas fa-edit"></i--></a>';
                                                        ...
                                                        function nameFormatterMappa1(value, row) {
                                                            //var test_id= row.id;
                                                            return ' <button type="button" class="btn btn-info btn-sm" title="anteprima mappa" data-toggle="modal" data-target="#myMap' +
                                                                value + '"><i class="fas fa-map-marked-alt"></i></button> \
                                                                <div class="modal fade" id="myMap' + value + '" role="dialog"> \
                                                                <div class="modal-dialog"> \
                                                                <div class="modal-content">\
                                                                    <div class="modal-header">\
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>\
                                                                    <h4 class="modal-title">Anteprima segnalazione ' +
                                                                value +
                                                                '</h4>\
                                                                    </div>\
                                                                    <div class="modal-body">\
                                                                    <iframe class="embed-responsive-item" style="width:100%; padding-top:0%; height:600px;" src="/../mappa_leaflet.php#17/' +
                                                                row.lat + '/' + row.lon + '"></iframe>\
                                                                    </div>\
                                        ...
                                        <div class="col-lg-12">
                                            <div class="table-responsive">
                                                ...
                                                function presidiFormatterEdit(value) {
                                                    ...
                                                    return '<a class="btn btn-warning" href=./dettagli_sopralluogo_mobile.php?id=' +
                    ...
                    <?php
                    $query =
                        "SELECT count(id) FROM segnalazioni.v_segnalazioni;";
                    ...
                    $query =
                        "SELECT count(id) FROM segnalazioni.v_segnalazioni WHERE in_lavorazione='t';";
                    $result = pg_query($conn, $query);
                    while ($r = pg_fetch_assoc($result)) {
                        $segn_lav = $r["count"];
                    }
