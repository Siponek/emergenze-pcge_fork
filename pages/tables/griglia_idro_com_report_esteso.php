...
//   UNION 
  ...
  max(l.data_ora) AT TIME ZONE 'UTC' AT TIME ZONE 'CEST' AS last_update,
    ...
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
          ...
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '24:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '23:00:00'::interval)) AS \"24\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '23:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '22:00:00'::interval)) AS \"23\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '22:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '21:00:00'::interval)) AS \"22\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '21:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '20:00:00'::interval)) AS \"21\",
        ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '20:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '19:00:00'::interval)) AS \"20\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '19:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '18:00:00'::interval)) AS \"19\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '18:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '17:00:00'::interval)) AS \"18\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '17:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '16:00:00'::interval)) AS \"17\",
            ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '16:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '15:00:00'::interval)) AS \"16\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '15:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '14:00:00'::interval)) AS \"15\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '14:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '13:00:00'::interval)) AS \"14\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '13:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '12:00:00'::interval)) AS \"13\",
        ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '12:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '11:00:00'::interval)) AS \"12\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '11:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '10:00:00'::interval)) AS \"11\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '10:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '09:00:00'::interval)) AS \"10\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '09:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '08:00:00'::interval)) AS \"9\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '08:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '07:00:00'::interval)) AS \"8\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '07:00:00'::interval) AND lettura_idrometri_comune.data_ora < (timezone('utc'::text, now()) - '06:00:00'::interval)) AS \"7\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
    ...
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= (timezone('utc'::text, now()) - '01:00:00'::interval) AND lettura_idrometri_comune.data_ora < timezone('utc'::text, now())) AS \"1\",
    ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
       ...
       ( SELECT greatest(max(lettura_idrometri_comune.lettura),0) AS max
           FROM geodb.lettura_idrometri_comune
          WHERE p.id::text = lettura_idrometri_comune.id_station::text AND lettura_idrometri_comune.data_ora >= timezone('utc'::text, now())) AS \"00\"
