...
<nav class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#mappa_segnalazioni"><i class="fas fa-map-marked-alt"></i> Mappa
                    segnalazioni</a>
            </li>
            <?php } else { ?>
            <li class="nav-item active">
            ...
            <?php }
            if (in_array($profilo_sistema, [10, 11]) == false) { ?>
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <ul class="nav nav-third-level">
                        <?php if ($check_evento == 1) {
                            $len = count($eventi_attivi);
                            for ($i = 0; $i < $len; $i++) { ?><li>
                            <a href="dettagli_evento.php?e=<?php echo $eventi_attivi[
                                $i
                            ]; ?>">
                    ...
                    <ul class="nav nav-third-level">
                        <?php if ($check_evento == 1) {
                            ...
                            for ($i = 0; $i < $len; $i++) { ?><li>
                            <a href="dettagli_evento_c.php?e=<?php echo $eventi_attivi_c[
                                $i
                            ]; ?>">
                                <i class="fas fa-chart-line"></i> Dettagli evento
                                - Id=<?php echo $eventi_attivi_c[
                                    $i
                                ]; ?>
                            </a>
                        </li>
                    ...
                    <?php if ($profilo_ok == 3) { ?>
                    <li>
                        <a href="attivita_sala_emergenze.php"><i class="fas fa-sitemap"></i> Assegna turni sala
                            emergenze</a>
                    </li>
                    <li>
                        <a href="storico_sala_emergenze.php"><i class="fas fa-history"></i> Storico turni sala
                            emergenze</a>
                    </li>
                    <?php } ?>
                    <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <?php if ($check_evento == 1) {
                        $len = count($eventi_attivi);
                        for ($i = 0; $i < $len; $i++) { ?><li>
                        <a href="monitoraggio_meteo.php?id=<?php echo $eventi_attivi[
                            $i
                        ]; ?>">
                            <i class="fas fa-chart-line"></i> Monitoraggio meteo
                            <br>
                            <small>
                                (Tipo <?php echo $tipo_eventi_attivi[
                                    $i
                                ][1]; ?> - Id=<?php echo $eventi_attivi[
                                    $i
                                ]; ?>)
                            </small>
                        </a>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="elenco_presenti_storico.php"><i class="fas fa-user-times"></i> Storico utenti
                            presenti</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="elenco_richieste.php">
                    ...
                    <br> <small>(<i class="fas fa-play"></i>eventi in corso / <i class="fas fa-hourglass-half"></i> in
                        chiusura)</small></a>
            </li>
            <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="dettagli_evento_c.php"><i class="fas fa-hourglass-end faa-ring animated"></i> Dettagli
                            eventi in fase di chiusura</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="elenco_segnalazioni.php">Elenco delle segnalazioni
                            <br><small> (<i class="fas fa-play"></i>eventi in corso / <i
                                    class="fas fa-hourglass-half"></i> in chiusura)</small>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="elenco_richieste.php">
                            ...
                            <br> <small>(<i class="fas fa-play"></i>eventi in corso / <i
                                    class="fas fa-hourglass-half"></i> in chiusura)</small></a>
                    </li>
                    ...
                    <li>
                        <a href="elenco_comunicazioni_riservate.php"> <i class="fas fa-user-secret"></i><i
                                class="fas fa-comments"></i>Elenco comunicazioni riservate
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <?php if (
                        $profilo_ok == 3 or
                        $profilo_sistema == 8 and $uo_inc == "uo_1"
                    ) { ?>
                    <li>
            ...
            <li>
                <a href="#"><i class="fas fa-exclamation-triangle"></i> Provvedimenti cautelari <span
            ...
            <?php if ($profilo_sistema == 1) { ?>
            <li>
                <a href="#"><i class="fa fa-user-shield"></i> Funzionalità amministratore sistema<span
                        class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
...
<!-- 
        <div style="text-align: center;">
            <a target="_new" title="Vai al sito https://allertaliguria.regione.liguria.it/"
                href="https://allertaliguria.regione.liguria.it/">
                <img class="nav nav-second-level" imageborder="0"
                    alt="Problema di visualizzazione immagine causato da sito https://allertaliguria.regione.liguria.it/"
